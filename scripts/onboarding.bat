...
echo    %P_PURPLE%(o.o)%RESET%   %B_PURPLE%bp-go-def Onboarding%RESET% %GRAY%by%RESET% %B_WHITE%GabrielTenma%RESET%
echo   %P_PURPLE%c(")(")%RESET%
echo %GRAY%----------------------------------------------------------------------%RESET%
echo %B_CYAN%Welcome to the bp-go-def onboarding setup!%RESET%
