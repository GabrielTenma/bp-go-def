...
# Onboarding Script for bp-go-def
...
echo -e "   ${P_PURPLE}(o.o)${RESET}   ${B_PURPLE}bp-go-def Onboarding${RESET} ${GRAY}by${RESET} ${B_WHITE}GabrielTenma${RESET}"
echo -e "  ${P_PURPLE}c(\")(\")${RESET}"
echo -e "${GRAY}----------------------------------------------------------------------${RESET}"
echo -e "${B_CYAN}Welcome to the bp-go-def onboarding setup!${RESET}"
